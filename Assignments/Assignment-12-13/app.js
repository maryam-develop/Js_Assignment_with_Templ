...
// if(userInput >= 65 && userInput <=90 || userInput >= "A" && userInput <= "Z" ){
// console.log("uppercase letter")
// }else if (userInput >= 97 && userInput <=122 || userInput >= "a" && userInput <= "z" ){
...
// var user_time = +prompt("Time please");
// if (user_time < 2400) {   
// if (user_time >= 00 && user_time < 1200) {
// alert("Good Morning");
